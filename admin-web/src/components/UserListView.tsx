  ...
  return (
    <div className="space-y-6 font-sans text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-xl border border-zinc-200 shadow-xs">
        <div>
          <h2 className="text-xl font-bold text-zinc-900">Quản lý khách hàng</h2>
          <p className="text-xs text-zinc-500 mt-0.5">Danh sách tài khoản người dùng và hội viên trên ứng dụng</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-xs overflow-hidden">
        {filteredUsers.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-xs text-zinc-500 mt-1">Thử tìm kiếm theo tên, email hoặc SĐT khác</p>
          </div>
        ) : (
